                                       ...
                                       const struct of_device_id *match)
{
	...
	/* Get MSI ranges */
	rc = of_address_to_resource(dev->dev.of_node, 0, &rmsi);
	if (rc) {
	...
	rc = of_address_to_resource(dev->dev.of_node, 1, &res);
	...
	/* Get the sdr-base */
	sdr_base = (u32 *)of_get_property(dev->dev.of_node, "sdr-base", NULL);
...
#elif defined(CONFIG_APM82181) || defined(CONFIG_460EX)
