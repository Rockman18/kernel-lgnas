...
{
	struct device_node *pka_np = cfg->ofdev->dev.of_node;
	int rc = 0;
 ...
 */
static int pka4xx_probe(struct platform_device *ofdev,
...
static int pka4xx_remove(struct platform_device *dev)
{
	pka4xx_hw_deinit();
	pka4xx_config_clear();
	return 0;
