...
{
	struct device_node *rng_np = cfg->ofdev->dev.of_node;
	int rc = 0;
 ...
 *
 */
static int trng4xx_probe(struct platform_device *ofdev,
...
static int __devexit trng4xx_remove(struct platform_device *dev)
{
